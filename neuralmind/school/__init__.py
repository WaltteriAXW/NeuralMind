...
from this machine -- rather than being absent. Two of the roadmap's stages are
in that state today and both are listed, because a curriculum that hides what
it cannot reach reports a smaller, better-looking mind than the one that
exists.
